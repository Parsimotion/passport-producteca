...
function Strategy(options, verify, locale) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://localhost:8081/oauth/authorise';
  options.tokenURL = options.tokenURL || 'https://localhost:8081/oauth/token';
  this.profileUrl = options.profileUrl || 'https://localhost:8081/users/me';
