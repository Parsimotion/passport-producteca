...
function Strategy(options, verify, locale) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://auth.producteca.com/oauth/authorise';
  options.tokenURL = options.tokenURL || 'https://auth.producteca.com/oauth/token';
  this.profileUrl = options.profileUrl || 'https://auth.producteca.com/users/me';
